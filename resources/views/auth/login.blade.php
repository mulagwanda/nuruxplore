...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .auth-card {
            position: relative; z-index: 10; width: 100%; max-width: 440px; margin: auto;
        ...
        .checkbox-label input { width: 16px; height: 16px; accent-color: #7c5cff; cursor: pointer; }
...
<body>
        ...
        <form id="loginForm">
            ...
            <button type="submit" id="submitBtn" class="btn-primary">
                ...
                <span id="btnLoader" style="display:none;">
                    <span style="width:18px;height:18px;border:2px solid rgba(255,255,255,0.3);border-top-color:#fff;border-radius:50%;animation:spin 0.8s linear infinite;display:inline-block;"></span>
                    Logging in...
                </span>
            </button>
        </form>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok && data.token) {
                    ...
                    if (rememberMe) { localStorage.setItem('nuruxplore_remembered_email', email); }
                    else { localStorage.removeItem('nuruxplore_remembered_email'); }
        ...
        function showError(msg) { const b = document.getElementById('msgBox'); b.innerHTML = msg; b.className = 'msg-box msg-error'; b.style.display = 'block'; }
        function showSuccess(msg) { const b = document.getElementById('msgBox'); b.textContent = msg; b.className = 'msg-box msg-success'; b.style.display = 'block'; }
        function resetButton() { document.getElementById('btnText').style.display = 'inline'; document.getElementById('btnLoader').style.display = 'none'; document.getElementById('submitBtn').disabled = false; }
    </script>
</body>
</html>